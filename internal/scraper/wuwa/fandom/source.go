...
const (
	DefaultAPIURL   = "https://wutheringwaves.fandom.com/api.php"
	DefaultPageURL  = "https://wutheringwaves.fandom.com/wiki/Redemption_Code"
...
func (s *Source) ID() string       { return "wuwa-fandom" }
func (s *Source) GameSlug() string { return "wuwa" }
