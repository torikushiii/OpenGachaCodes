...
const (
	DefaultPageURL  = "https://game8.co/games/Neverness-to-Everness/archives/593718"
...
func (s *Source) ID() string       { return "nte-game8" }
func (s *Source) GameSlug() string { return "nte" }
