...
func TestCatalogRegistersGamesAndSources(t *testing.T) {
	...
	if games[0].Slug != "genshin" || games[0].Name != "Genshin Impact" || games[1].Slug != "starrail" || games[1].Name != "Honkai: Star Rail" || games[2].Slug != "zenless" || games[2].Name != "Zenless Zone Zero" || games[3].Slug != "endfield" || games[3].Name != "Arknights: Endfield" {
